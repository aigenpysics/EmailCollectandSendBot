...
for j in range(199):    #change page until it's 200   
    ...
    time.sleep(delay)
    url = f'https://search.shopping.naver.com/search/category/100000027?catId=50000425%2050000435%2050001487%2050001488%2050004142%2050004143%2050004144%2050004141&iq=%EC%97%AC%EC%84%B1&origQuery&pagingIndex={page}&pagingSize=40&productSet=&query&sort=rel&spec=M10011455%7CM10537277&timestamp=&viewType=list'
    ...
    write_list_to_csv(BackToList(email_lst), 'emailGathering.csv')
    print("Save to data...")
